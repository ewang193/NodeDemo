...
// taken from jQuery
    ...
    var labels = {
        ...
        add: function(pie, section, sectionDisplayType) {
            ...
            var colors = pie.options.misc.colors.segments[0];
            ...
            if (include.mainLabel) {
                ...
                labelGroup.append("text")
                    ...
                    .style("font-size", settings.mainLabel.fontSize + "em")
        ...
        positionLabelElements: function(pie, section, sectionDisplayType) {
            ...
            if(section == "outer"){
                d3.selectAll("." + pie.cssPrefix + "segmentValue-" + section)
                    .attr("transform", function(d, i){return "translate(" +pie.options.size.canvasHeight * 0.1 + "," + (pie.options.size.canvasHeight * 0.65 + i * 40) + ")";});
        ...
        computeLinePosition: function(pie, i) {
            ...
            switch (quarter) {
                case 0:
                    ...
                    // x3 = (pie.outerLabelGroupData[i].x - labelXMargin) * 2;
                    // y3 = (pie.outerLabelGroupData[i].y - heightOffset) * 2;
                    // if(pie.options.id == "outer"){
                ...
                case 2:
                    ...
                    y2 = originCoords.y + (pie.outerLabelGroupData[i].y - originCoords.y) / midPoint;
                    // x3 = (pie.outerLabelGroupData[i].x + pie.outerLabelGroupData[i].w + labelXMargin) * 0.3;
                    // y3 = (pie.outerLabelGroupData[i].y - heightOffset) * 0.3;
                    // if(pie.options.id == "outer"){
                ...
                case 3:
                    ...
                    y2 = pie.outerLabelGroupData[i].y + (originCoords.y - pie.outerLabelGroupData[i].y) / midPoint;
                    // x3 = (pie.outerLabelGroupData[i].x + pie.outerLabelGroupData[i].w + labelXMargin) * 0.5;
                    // y3 = (pie.outerLabelGroupData[i].y - heightOffset) * 0.5;
                    // if(pie.options.id == "outer"){
                        x3 = (pie.outerLabelGroupData[i].x + pie.outerLabelGroupData[i].w + labelXMargin);
                        y3 = (pie.outerLabelGroupData[i].y - heightOffset);
                    // }
        ...
        positionLabelGroups: function(pie, section) {
            ...
            d3.selectAll("." + pie.cssPrefix + "labelGroup-" + section)
                ...
                .attr("transform", function(d, i) {
                    var x, y;
                    if (section === "outer") {
                        x = pie.options.size.canvasWidth * 0.01;
                        y = pie.options.size.canvasHeight * 0.65 + i * 20;
                    } else {
            ...
            d3.selectAll("." + pie.cssPrefix + "segmentMainLabel-" + section)
                .style("font-size", "1em")
                .attr("transform", function(d, i){
                    var x, y;
                    if(section === "outer"){
        ...
        getIdealOuterLabelPositions: function(pie, i) {
            ...
            // if(pie.options.ps_outer_inner == "outer"){
            //     if(angle > 180){
            //         pie.outerLabelGroupData[i] = {
            //             x: newCoords.x,
            //             y: newCoords.y,
            ...
            // } else {
            //     if(hemisphere == "left"){
            //         // var x_label = newCoords.x;
            //         // var y_label = newCoords.y;
            //         pie.outerLabelGroupData[i] = {
            //             x: newCoords.x * 0.5,
            //             y: newCoords.y * 0.8,
            //             w: labelGroupDims.width,
    ...
    var segments = {
        ...
        create: function(pie) {
            ...
            if(pie.options.id == "inner") {
                pieChartElement.style("pointer-events", "auto");
            }
        ...
        addSegmentEventHandlers: function(pie) {
            ...
            var arc = d3.selectAll("." + pie.cssPrefix + "arc,." + pie.cssPrefix + "labelGroup-inner");

            arc.on("click", function(d) {
                var currentEl = d3.select(this);
                console.log("currentEl:", currentEl.attr("style"));
                var segment;
        ...
        addTooltips: function(pie) {
            ...
            tooltips.selectAll("." + pie.cssPrefix + "tooltip")
                ...
                .attr({
                    ...
                    // stroke-width: pie.options.tooltips.styles.strokewidth,
                    opacity: pie.options.tooltips.styles.backgroundOpacity
                    // position: "absolute"
                    // z-index: 10
                })
                .style("stroke", pie.options.tooltips.styles.stroke)
                .style("stroke-width", pie.options.tooltips.styles.strokewidth)
                .style("fill", "white");
            ...
            tooltips.selectAll("." + pie.cssPrefix + "tooltip rect")
                .attr({
                    width: function (d, i) {
                        ...
                        return dims.w + (2 * pie.options.tooltips.styles.padding) + 50;
                    },
                    height: function (d, i) {
                        var dims = helpers.getDimensions(pie.cssPrefix + "tooltip" + i);
                        return dims.h + (2 * pie.options.tooltips.styles.padding) + 20;
                    },
                    y: function (d, i) {
                        var dims = helpers.getDimensions(pie.cssPrefix + "tooltip" + i);
                        return -(dims.h / 2) + 1;
